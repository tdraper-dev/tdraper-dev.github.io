...
const CodeBlurb = ({ projectTitle, sourceCode }) => {
  return (
    <div className="blogTextCenter">
      <br/>
      <br/>
      <i>Check out the source code for {projectTitle}
        <br/> 
        <a rel="noreferrer" ariaLabel={`Source code for ${projectTitle} on Github`}href={sourceCode} target="_blank">
          {sourceCode} 
        </a>
      </i>
    </div>
...
const dungeonMap = 
  <div>
    ...
    <CodeBlurb projectTitle='Dungeon Map!' sourceCode='https://github.com/tdraper-dev/thedungeonmap' />

  </div>

const travelMoney = 
  <div>
    I built <Link className="aboutTextLink" to="/Projects"><i>TravelMoney</i></Link> as a web development exercise focused on utilizing React and React class components. This was my first zero guidance project built with React. I share this project in my portfolio because I feel it showcases a clean UX and makes use of a more legacy-minded React code now that hooks are the norm. The app utilizes the <a className="aboutTextLink" rel="noreferrer" href="https://lodash.com/" target="_blank" ariaLabel="Path to lodash's function library">lodash</a> function library and makes fetch requests to <a className="aboutTextLink" rel="noreferrer" href="https://www.wikipedia.com" target="_blank" ariaLabel="Path to Wikipedia">Wikipedia</a> as well as the <a className="aboutTextLink" rel="noreferrer" href="https://www.frankfurter.app/" target="_blank" ariaLabel="Path to Frankfurter's currency conversion API website">Frankfurter</a> currency conversion API. I feel this app also demonstrates a habit of mine:  build with theme in mind. 
    <br />
    <br />
...
const dawdlist =
  <div>
    ...
    <br/>
    <br/>
    <i>Dawdlist</i> is an app that I would love to remake. I want to go back in there, probably using a React framework, and create an app that allows for multiple navigable lists, the possibility for public and private lists, and the distillation of "priority tasks" by aggregating the repetition of repeated tasks across public lists. I think for the time being, however, my time will be better spent developing new apps that explore different aspects of my toolkit. I'm proud to share <Link className="aboutTextLink" to="/Projects" ariaLabel="Path to Travis Draper projects page of his portfolio"><i>Dawdlist</i></Link> in this portfolio, however, as I feel it demonstrates my curiousity and problem-sovling nature, as well as my need to create a product that satifies use cases.

    <CodeBlurb projectTitle='Dawdlist...' sourceCode='https://github.com/tdraper-dev/dawdlist' />
  </div>
